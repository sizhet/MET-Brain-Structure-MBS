...
During dreaming, similar tunnels may be replayed, recombined, reinforced, or explored.
...
Under such conditions, the ability to rapidly activate relevant behavioral pathways becomes critical.
...
The MBS project proposes a simple but potentially powerful interpretation:

Dreaming may reveal the operation of an ancient structural runtime system.
